...
# 加载 TFLite 模型
interpreter = tf.lite.Interpreter(model_path='modelfloat16.tflite')
...
arr =[0.641, 0.5507246, 0.875, 0.39520285, 0.7]
arr = [0.6413044, 0.78, 1, 0.41352323, 0.3]
input_data = np.array(arr).reshape(np.array([1, 5], dtype=np.int32)).astype(np.float32)
